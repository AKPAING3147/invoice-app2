...
INSERT INTO "new_Voucher" ("customerId", "date", "id", "items", "status", "total", "userId", "voucher_no") SELECT "customerId", "date", "id", "items", "status", "total", "userId", "voucher_no" FROM "Voucher";
DROP TABLE "Voucher";
